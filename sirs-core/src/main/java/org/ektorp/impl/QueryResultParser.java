...
/**
 * Surcharge du QueryResultParser d'Ektorp pour supporter les vues renvoyant une valeur d'offset "null". (SYM-1824)
 * 
 * 
 * @author Henrik Lundgren (original implementation)
 * @author Pascal Gélinas (rewrite for issue #98)
 * @author Samuel Andrés (surcharge de la classe correspondante d'Ektorp)
 */
    ...
    private void parseResult(JsonParser jp) throws IOException {
        ...
        while (jp.nextValue() != JsonToken.END_OBJECT) {
            ...
            if (OFFSET_FIELD_NAME.equals(currentName)) {
                /*
                support des offset à "null"
                offset = jp.getLongValue();
                */
                offset = jp.readValueAs(Long.class);
