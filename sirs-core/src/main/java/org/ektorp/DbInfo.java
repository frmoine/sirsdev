...
/**
 * Surcharge de la classe DbInfo d'Ektorp pour gérer le changement de version de couchDB (2.2 to 2.3). (SYM-1881)
 * 
 * Modification : int purgeSeq -> String purgeSeq
 * 
 * @author Henrik Lundgren (original implementation)
 * @author Matthieu Bastianelli et Alexis Manin (surcharge de la classe correspondante d'Ektorp)
 */
public class DbInfo implements Serializable {
    ...
    // Type de l'attribut modifié par rapport à la classe ektorp
